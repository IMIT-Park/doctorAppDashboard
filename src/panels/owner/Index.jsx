                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-6 text-white">
                    ...
                    <div className="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
                        <div className="flex justify-between">
                            <div className="ltr:mr-1 rtl:ml-1 text-md font-semibold">Clinics</div>
                        </div>
                        <div className="flex items-center mt-3">
                            <div className="text-3xl font-bold ltr:mr-3 rtl:ml-3"><CountUp start={0} end={67} duration={4}></CountUp> </div>
                        </div>
                    ...
                    <div className="panel bg-gradient-to-r from-violet-500 to-violet-400">
                        <div className="flex justify-between">
                            <div className="ltr:mr-1 rtl:ml-1 text-md font-semibold">Transactions</div>
                        </div>
                        <div className="flex items-center mt-3">
                            <div className="text-3xl font-bold ltr:mr-3 rtl:ml-3"><CountUp start={0} end={74} duration={4}></CountUp></div>
                        </div>
                    ...
                    <div className="panel bg-gradient-to-r from-blue-500 to-blue-400">
                        <div className="flex justify-between">
                            <div className="ltr:mr-1 rtl:ml-1 text-md font-semibold">Banners</div>
                        </div>
                        <div className="flex items-center mt-3">
                            <div className="text-3xl font-bold ltr:mr-3 rtl:ml-3"><CountUp start={0} end={34} duration={4}></CountUp></div>
                        </div>
                    ...
                    <div className="panel bg-gradient-to-r from-fuchsia-500 to-fuchsia-400">
                        ...
                        <div className="flex items-center mt-3">
                            <div className="text-3xl font-bold ltr:mr-3 rtl:ml-3"><CountUp start={0} end={49} duration={4}></CountUp>%</div>
                        </div>
                        <IconMenuUsers className="absolute top-[50%] translate-y-[-50%] right-5 size-8" />
                    </div>
                </div>
