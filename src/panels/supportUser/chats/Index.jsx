...
const Chat = () => {
  ...
  const supportUserRoleId = userData?.role_id || 0;
  ...
  const selectUser = (user) => {
    ...
    setTextMessage({ ...textMessage, owner_id: user?.owner_id || "" });
                            ...
                            <div key={message?.message_id}>
                              <div
                                className={`flex items-start gap-3 ${
                                  supportUserRoleId == message?.sender_role_id
                                    ? "justify-end"
                                    : ""
                                }`}
                              >
                                ...
                                <div className="space-y-2">
                                  <div className="flex items-center gap-3 relative">
                                    <div
                                      className={`dark:bg-gray-800 px-3 py-2 rounded-md max-w-[480px] bg-black/10 ${
                                        supportUserRoleId ==
